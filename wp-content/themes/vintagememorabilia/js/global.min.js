...
(function (c, h) {
  ...
  c.totalStorage.impl = {
    ...
    getAll: function getAll() {
      var b = [];
      if (e) for (var a in d) a.length && b.push({
        key: a,
        value: this.parseResult(d.getItem(a))
      });else try {
        ...
        for (a = 0; a < g.length; a++) {
          ...
          b.push({
            key: f,
            value: this.parseResult(c.cookie(f))
          });
        }
      } catch (h) {
        return null;
    ...
    parseResult: function parseResult(b) {
      var a;
      try {
        a = JSON.parse(b), "undefined" == typeof a && (a = b), "true" == a && (a = !0), "false" == a && (a = !1), parseFloat(a) == a && "object" != _typeof(a) && (a = parseFloat(a));
      } catch (c) {
        a = b;
      }
      return a;
...
var VMSite = {
  ...
  init: function init() {
    ...
    VMSite.nav.colheightsInterval = setInterval(function () {
      VMSite.nav.colheights();
    }, 750);
    ...
    if (VMSite.util.LocalStorage.get('cacheKey') !== VMSiteCacheKey || !VMSite.util.LocalStorage.get('typeahead') || VMSite.util.TimeElapsed({
      time: VMSite.util.LocalStorage.get('typeahead.timestamp'),
      unit: 'm'
    }) > 10) {
      $.get(vmSiteDir + 'ajax_calls.php?type=typeahead' + VMSite.params.ajaxNoCache).done(function (json) {
  ...
  blog: {
    init: function init() {
      ...
      $('#VMSite').on('click', 'form.blogSidebar .btn', function (e) {
        e.preventDefault;
        ...
        var formSubmit = function formSubmit() {
          ...
          setTimeout(function () {
            $.post(vmSiteDir + 'incs/ajaxCalls_v2dynamic.cfm?type=postContact', form.serialize(), function (data) {
              ...
              formLoading.css({
                opacity: '1'
              }).prepend('<div class="alert alert-' + msgType + '">' + msgText + '</div>');
              if (data.success) {
                setTimeout(function () {
      ...
      $('#contactUploader').pluploadQueue({
        ...
        init: {
          ...
          FileUploaded: function FileUploaded(up, file, info) {
            ...
            setTimeout(function () {
              $('#contactUploader li.plupload_done .plupload_file_action a').html('<i class="fa fa-check-circle" style="color:green;"></i>').click(function (e) {
                e.preventDefault();
              });
            }, 500);
          },
  ...
  gallery: {
    heights: function heights(categorylinks) {
  ...
  itemdetail: {
    init: function init() {
      ...
      $('.product-imgs').on('click', '.zoomLink', function (e) {
        ...
        if (!VMSite.itemdetail.isZoomed) {
          ...
          mobileZoom.find('.zoomLink').addClass('MagicZoom').each(function () {
            ...
            $(this).find('img').attr('src', vmSiteDir + 'images/pages/blank_900.png').css({
              width: '100%',
              height: '300px',
              background: 'url(' + src.replace('thumbsm', 'thumblg') + ') center center no-repeat'
            });
            MagicZoom.refresh(this);
            $('body .mz-zoom-window').css({
              zIndex: 99900
            });
          });
      ...
      $('.actionBar').on('click', '.actionLink[href="#formPurchase"],.actionLink[href="#formPriceReduced"]', function (e) {
        ...
        $('#detailZoom').removeClass('hidden').addClass('formInlinePopup').find('.linkContainer .zoom-images').html($($(this).attr('href')).html()).end().find('.instructions').addClass('hidden').end();
        $('#detailZoom').removeClass('hidden').parent('div').addClass('visible-xs').end().find('form label').each(function () {
          $(this).data('origText', $(this).text());
        });
        VMSite.nav.colheights();
        $('html,body').animate({
          scrollTop: $('#detailZoom').offset().top - 55 + 'px'
        }, 500);
      });
      $('#detailZoom').on('submit', '.formPurchase form', function (e) {
        ...
        setTimeout(function () {
          $.post(vmSiteDir + 'incs/ajaxCalls_v2dynamic.cfm?type=postPurchase', form.serialize(), function (data) {
            ...
            loader.remove();
            $('html,body').animate({
              scrollTop: msg.offset().top - 55 + 'px'
            }, 500);
            if (data.success) {
              setTimeout(function () {
  ...
  nav: {
    ...
    init: function init() {
      var $VMSite = $('#VMSite');
      $VMSite.on('click', '.navbar.navbar-inverse button.navbar-toggle', function (e) {
        e.preventDefault();
        $(this).blur();
        if (!VMSite.nav.open) {
    ...
    fixed: function fixed() {
      ...
      $(window).on('resize', function () {}).on('scroll', function () {
  ...
  util: {
    ...
    Device: function Device() {
      ...
      window[$vars.keyWin] = window[$vars.keyWin] ? window[$vars.keyWin] : {
        deviceAgent: VMSite.util.LocalStorage.get($vars.keyCookie) ? VMSite.util.LocalStorage.get($vars.keyCookie) : 'desktop'
      };
      var devices = {
        Mobile: [0, 40],
        Tablet: [40, 64],
    ...
    Hash: function Hash(str, len, randomize) {
    ...
    Hex2Rgba: function Hex2Rgba(params) {
      ...
      switch (obj.type) {
        case 'overlay':
          ...
          loaderObj.css({
            ...
            top: '0',
            width: '100%',
            height: obj.ele.innerHeight() + 'px',
            zIndex: 99999,
            background: VMSite.util.Hex2Rgba({
              hex: obj.bgColor,
              alpha: obj.bgAlpha
            }),
            color: obj.color
          ...
          spinner.css({
            position: 'absolute',
            display: 'block',
            left: obj.spinnerLeft,
            top: obj.spinnerTop,
            margin: '-' + spinner.outerWidth() / 2 + 'px 0px 0px -' + spinner.outerHeight() / 2 + 'px'
          });
          return loaderObj;
          break;
        default:
    ...
    LocalStorage: {
      ...
      has: function has(lsKey) {
        return this["do"]('has', lsKey);
      },
      get: function get(lsKey) {
        return this["do"]('get', lsKey);
      },
      set: function set(lsKey, lsVal) {
        return this["do"]('set', lsKey, lsVal);
      },
      del: function del(lsKey) {
        return this["do"]('del', lsKey);
      },
      "do": function _do(action, lsKey, lsVal) {
        var $util = VMSite.util;
    ...
    TimeElapsed: function TimeElapsed(obj) {
      var defaultObj = {
        time: 0,
        unit: false,
        abbr: false
...
full = month + "." + day + "." + year;
var LeftCorner = {
  _CommaForThousands: function _CommaForThousands(n) {
  ...
  ArrayAppend: function ArrayAppend(a, v) {
    a[a.length] = v;
    return a;
  },
  ArraySort: function ArraySort(a, st, so) {
    var _so;
    if (st.toUpperCase() == 'TEXTNOCASE') {
      if (!so || so.toUpperCase() != "DESC") {
        _so = function _so(a, b) {
          a = a.toUpperCase();
          b = b.toUpperCase();
          if (a < b) {
            return -1;
  ...
  ArrayToList: function ArrayToList(a, d) {
    if (!d) {
      d = ",";
    }
    var re = /[,]/gi;
  ...
  ArrayLen: function ArrayLen(a) {
    return a.length;
  },
  Ceiling: function Ceiling(n) {
    return Math.ceil(n);
  },
  ...
  CompareNoCase: function CompareNoCase(s1, s2) {
    return this.Compare(s1.toUpperCase(), s2.toUpperCase());
  },
  DateDiff: function DateDiff(dp, d1, d2) {
    var dt1 = new Date(d1);
    var dt2 = new Date(d2);
  ...
  DecimalFormat: function DecimalFormat(n) {
    var r = n.toFixed(2);
  ...
  DollarFormat: function DollarFormat(n) {
  ...
  Find: function Find(sb, s) {
    return s.toString().indexOf(sb) + 1;
  },
  FindNoCase: function FindNoCase(sb, s) {
    return this.Find(sb.toUpperCase(), s.toUpperCase());
  },
  Insert: function Insert(sb, s, p) {
  ...
  IsNumeric: function IsNumeric(s) {
    if (isNaN(s)) {
      return false;
    } else {
      return true;
  ...
  LCase: function LCase(s) {
    return s.toLowerCase();
  },
  Left: function Left(s, c) {
    return s.slice(0, c);
  },
  Len: function Len(s) {
    return s.length;
  },
  ListAppend: function ListAppend(l, v, d) {
    if (!d) {
      d = ",";
    }
    var r = "";
  ...
  ListDeleteAt: function ListDeleteAt(l, p, d) {
    if (!d) {
      d = ",";
    }
    var i, posInList;
  ...
  ListFind: function ListFind(l, v, d) {
    if (!d) {
      d = ",";
    }
    var r = 0;
  ...
  ListFindNoCase: function ListFindNoCase(l, v, d) {
    if (!d) {
      d = ",";
    }
    return this.ListFind(l.toUpperCase(), v.toUpperCase(), d);
  },
  ListGetAt: function ListGetAt(l, p, d) {
    if (!d) {
      d = ",";
    }
    return l.split(d)[p - 1];
  },
  ListLen: function ListLen(l, d) {
    if (!d) {
      d = ",";
    }
    return l.split(d).length;
  },
  ListToArray: function ListToArray(l, d) {
    var r, a, i;
    if (!d) {
      d = ",";
    }
  ...
  Mid: function Mid(s, start, c) {
    start -= 1;
    return s.slice(start, start + c);
  },
  Replace: function Replace(s, sb1, sb2, sc) {
  ...
  ReplaceNoCase: function ReplaceNoCase(s, sb1, sb2, sc) {
    if (!sc || sc.toUpperCase() != "ALL") {
      sc = "i";
    } else {
      sc = "gi";
  ...
  Right: function Right(s, c) {
    return s.slice(s.length - c, s.length);
  },
  Round: function Round(n, p) {
  ...
  UCase: function UCase(s) {
    return s.toUpperCase();
  },
  URLDecode: function URLDecode(s) {
    return unescape(s);
  },
  URLEncodedFormat: function URLEncodedFormat(s) {
    return encodeURI(s);
  }
};
var miscFunc = {
  ...
  NewWin: function NewWin(url, w, h, s) {
  ...
  Confirm: function Confirm(url, warning, confirmation) {
...
(() => {
"use strict";
/* harmony import */ var _main_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(414);
...
/* harmony import */ var _site_config_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(827);
/* harmony import */ var _site_config_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_site_config_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _jquery_total_storage_min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(502);
/* harmony import */ var _jquery_total_storage_min_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_jquery_total_storage_min_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _magiczoomplus_5_2_1_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(387);
/* harmony import */ var _magiczoomplus_5_2_1_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_magiczoomplus_5_2_1_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _jquery_fancybox_min_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(760);
/* harmony import */ var _jquery_fancybox_min_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_jquery_fancybox_min_js__WEBPACK_IMPORTED_MODULE_4__);
console.log('index.js imported successfully');
 // VMsite component
 // variables to use / Left corner
